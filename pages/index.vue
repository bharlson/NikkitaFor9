<template>
    <div class="grid grid-cols-1 gap-4 grid lg:grid-cols-2">
      <div class="col">
        <img class="w-100" src="https://ssl.gstatic.com/ui/v1/icons/mail/profile_mask_2x.png" alt="">
      </div>
      <div class="col">
        <h2>Meet Nikkita Oliver</h2>
