    ...
    <div class="p-4 lg:px-40 grid grid-cols-1">
      <ol>
        <li>
          ...
          <ol>
              <li>
                  <p><em>Stop the Sweeps</em> The current city policy of destroying encampments established by the unhoused is cruel, inhumane, and needs to end immediately. </p>
              </li>
              <li>
                  <p><em>Affordable Housing</em>We must rapidly build affordable housing throughout the city by increasing investments in social housing, ending zoning laws which have segregated Seattle, and prioritizing housing for Seattle’s Black Trans &amp; Queer communities. </p>
              </li>
              <li>
                  <p><em>House the Unhoused</em>The city should invest in hotels and tiny village accommodations for Seattleites experiencing homelessness. </p>
              </li>
              <li>
                  <p><em>Radical accessibility</em>The City of Seattle should create a fund inside the Seattle Parks and Recreation Department to support people who use the parks for housing, enabling parks to help sustainably and humanely address the needs of unsheltered people while expanding green spaces in the city and absorbing unneeded roadways. </p>
              </li>
              <li>
                  <p>Solidify an effective regional approach to addressing the housing affordability and homelessness crisis.</p>
              </li>
          </ol>
        </li><!--/Housing For All-->
        <li>
        ...
        </li><!--/Democracy and Participation-->
      </ol>
    </div>
  </main>
</template>
